...
#   i.e.   ${workspace_loc:CentralUnit}/make_launcher.bat


ERIKA_FILES=/home/hhunt/eclipse/EE_RT-Druid-2.8.0-juno-linux-gtk-x86_64/eclipse/plugins/com.eu.evidence.ee_2.8.0.20171025_0922/ee_files
export ERIKA_FILES
