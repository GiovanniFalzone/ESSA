...
\textbf{\LARGE Design of Embedded Systems}\\[1cm] ESSTA, Energy Saving Smart-home distributed Temperature control Application, Implementation}
...
\input{SySML.tex}
\input{CentralUnit_implementation.tex}
\input{room_implementation.tex}
\input{implementation_values.tex}
\input{CUnit.tex}
\input{future.tex}
